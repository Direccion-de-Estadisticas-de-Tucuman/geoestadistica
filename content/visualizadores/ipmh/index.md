...
<link
      ...
      rel="stylesheet"
/>
<script src="https://cdn.jsdelivr.net/npm/@maplibre/maplibre-gl-compare@0.5.0/dist/maplibre-gl-compare.min.js"></script>
<link
      rel="stylesheet"
      href="https://cdn.jsdelivr.net/npm/@maplibre/maplibre-gl-compare@0.5.0/dist/maplibre-gl-compare.min.css"
    />
          ...
          <fieldset>
            ...
            <div>
              ...
              <select name="selector" id="depto-selector">
                ...
                <option value="021">Chicligasta</option>
                <option value="014">Cruz Alta</option>
                <option value="028">Famaillá</option>
                <option value="035">Graneros</option>
                <option value="042">Juan Bautista Alberdi</option>
                <option value="049">La Cocha</option>
                <option value="056">Leales</option>
                <option value="063">Lules</option>
                <option value="070">Monteros</option>
                <option value="077">Río Chico</option>
                <option value="091">Simoca</option>
                <option value="098">Tafí Del Valle</option>
                <option value="105">Tafí Viejo</option>
                <option value="112">Trancas</option>
